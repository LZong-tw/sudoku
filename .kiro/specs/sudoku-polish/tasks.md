...
- [ ] 2. 實現核心數據模型和驗證
  ...
  - [ ] 2.2 為 GridModel 編寫基於屬性的測試
    - **屬性 9: 填入答案清除筆記**
    - **驗證需求：3.3**

  - [ ] 2.3 為 GridModel 編寫基於屬性的測試
    - **屬性 10: 有答案的格子不允許筆記**
    - **驗證需求：3.4**

  - [ ] 2.4 為 GridModel 編寫基於屬性的測試
    - **屬性 11: 自動檢查驗證規則違反**
    - **驗證需求：4.1, 4.5**

  - [ ] 2.5 為 GridModel 編寫基於屬性的測試
    - **屬性 12: 衝突檢測的完整性**
    - **驗證需求：4.2**

- [ ] 3. 實現歷史管理和撤銷/重做
  - [ ] 3.1 實現 HistoryManager 類
    - 實現歷史記錄棧和當前索引管理
...
- [ ] 9. 實現謎題庫和每日挑戰
  ...
  - [ ] 9.2 實現 PuzzleGenerator 類
    - 實現從謎題庫隨機選擇謎題
    - 實現已完成謎題追蹤和去重邏輯
    - 實現謎題驗證方法
    - _需求：12.2, 12.4_

  - [ ] 9.3 實現 DailyChallenge 類
    - 實現基於日期的確定性謎題生成
